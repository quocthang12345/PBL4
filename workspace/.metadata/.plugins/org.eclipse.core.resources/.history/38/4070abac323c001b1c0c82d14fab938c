        ...
        <div class="container-fluid">
            <nav>
                <ol class="breadcrumb direct-course">
                    <li class="breadcrumb-1"><a href="<c:url value='/trang-chu'/>">Trang chủ</a></li>
                    <li><i class="fas fa-chevron-right breadcrumb-2"></i></li>
                    <li class="breadcrumb-3"><a href="<c:url value='list-work'/>">Bộ phận</a></li>
                </ol>
            </nav>
            <form action="<c:url value='/list-work'/>">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 d-flex flex-row align-item-center">
                        <div class="description-banner col-12 col-sm-12 col-md-8 col-lg-8">
                            <div class="text-banner"><h2>Danh sách bộ phận <span style="color:blue">TNT Tech</span></h2>
                                <h3>Tra cứu công việc, hoàn thành deadline!</h3></div>
                            <div class="search">
           ...
           <c:forEach var="i" items="${ListSearch}">
            <div class="block-course">
                <div class="title-block">${i.teamName}</div>
                <div class="list-course">
                    <div class="row">
                    	<c:forEach var="j" items="${i.workTeam}">
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 mb-2">
	                        <div class="card course">
	                            ...
	                            <div class="card-body short-description-lesson">
	                                <h4><a onclick="callAPIUser(${j.id})"  href="<c:url value='/work-detail?id=${j.id}'/>" >${j.workName}</a></h4>
	                                	<input type="hidden" name="id" id="id" value="${j.id}"/>
	                                <p>${j.workDescription}</p>
          ...
          <c:if test="${empty ListSearch}">
           <c:forEach var="i" items="${listTeam}" varStatus="Index">
            <div class="block-course">
                <div class="title-block">${i.teamName}</div>
                <div class="list-course">
                    <div class="row">
                    	<c:forEach var="j" items="${i.workTeam}" varStatus="myIndex">
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 mb-2">
	                        <div class="card course">
	                            <div class="card-header img-lesson p-0">
	                                <img src="<c:url value='${j.thumbnail}'/>" alt="Java" />
	                            ...
	                            <div class="card-body short-description-lesson">
	                                <h4><a href="<c:url value='/work-detail?id=${j.id}'/>">${j.workName}</a></h4>
	                                <p>${j.workDescription}</p>
	                                <div class="rating d-flex flex-row align-items-center justify-content-between">
	                                    <ul class="rate d-flex flex-row align-items-center">
	                                        <li class="mr-2"><i class="fas fa-desktop mr-1"></i>55</li>
