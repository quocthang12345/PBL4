...
<head>
<meta charset="UTF-8">
<title><dec:title default="Video" /></title>
...
<link href="<c:url value='/template/web/css/video-lesson.css'/>" rel="stylesheet" type="text/css" />
</head>
<body>
...
<script src="<c:url value='https://code.jquery.com/jquery-3.4.1.slim.min.js'/>" integrity="sha384-J6qa4849blE2+poT4WnyKhv5vZF5SrPo0iEjwBvKU7imGFAV0wwj1yYfoRSJoZ+n" crossorigin="anonymous"></script>
