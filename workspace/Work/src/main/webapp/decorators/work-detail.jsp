...
<head>
<meta charset="UTF-8">
<title><dec:title default="Lesson" /></title>
...
<link href="<c:url value='/template/web/css/content-details.css'/>" rel="stylesheet" type="text/css" />
<link href="<c:url value='/template/web/css/course-details.css'/>" rel="stylesheet" type="text/css" />
