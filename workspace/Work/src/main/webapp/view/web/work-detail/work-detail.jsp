            ...
            <div class="row">
                <div class="col-md-5 col-lg-4 wrap-detail">  
                    <div class="img-detail">
                        <img src="<c:url value='https://via.placeholder.com/150' />" alt="lesson" />
                    </div>
                </div>
                                            ...
                                            <ul class="lesson" >
                                           		<c:forEach var="i" items="${listAssignment}">
	                                                <li>
		                                              ...
		                                              <button type="button" onclick="callAPI(${i.id})" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Xem công việc</button>
	                                                </li>
                                                </c:forEach>
                                            </ul>s
                                        </div>
					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLongTitle">Công việc cần làm</h5>
					      ...
					      <div class="modal-footer">
					        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#userModal">Xem nhân viên</button>
					      </div>
					    </div>
					  </div>
					</div>
				...
				<!-- Button trigger modal -->
					...
					<div class="modal fade" id="userModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLongTitle">Danh sách nhân viên phụ trách</h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
 ...
 function callAPI(index){
	     $.ajax({
	         ...
	         success: function (data) {
	        	 $('#example-description').html(data.assignmentDescription);
	         },
