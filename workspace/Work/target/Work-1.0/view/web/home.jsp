                    ...
                    <div class="content-item">
                        <div class="row d-flex flex-row justify-content-center align-items-center">
	                        <div class="item i-1 col-12 col-sm-12 col-lg-3 col-md-3">
		                            <ul>
		                                ...
		                                <li class="content">
		                                    <p class="header-title title-item-1"><a href="<c:url value='/khoa-hoc?keyword=Java Programming' />" style="text-decoration:none;">Marketing</a></p>
		                            </ul>
	                        </div>
                        <div class="item i-2 col-12 col-sm-12 col-lg-3 col-md-3">
                            <ul>
                                ...
                                <li class="content">
                                    <p class="header-title title-item-2"><a href="<c:url value='/khoa-hoc?keyword=C/' />" style="text-decoration:none;">Kĩ thuật</a></p>
                                </li>
                            </ul>
                        </div>
                        <div class="item i-3 col-12 col-sm-12 col-lg-3 col-md-3">
                            <ul>
                                ...
                                <li class="content">
                                    <p class="header-title title-item-3"><a href="<c:url value='/khoa-hoc?keyword=Javascript' />" style="text-decoration:none;">Chăm sóc khách hàng</a></p>
                                </li>
                            </ul>
                        </div>
                        <div class="item i-4 col-12 col-sm-12 col-lg-3 col-md-3">
                            <ul>
                                ...
                                <li class="content">
                                    <p class="header-title title-item-4"><a href="<c:url value='/khoa-hoc?keyword=Ruby' />" style="text-decoration:none;">An ninh</a></p>
                                </li>
                            </ul>
                        </div>
